...
function ButtonLogin({ setShowLogin, setShowRegister }) {
  return (
    <div className="block">
      ...
      <button
        className="max-w-sm border-2 border-blue-500 rounded-full font-semibold  text-white px-2  transition duration-300 ease-in-out hover:bg-white hover:text-blue-500 bg-blue-500"
